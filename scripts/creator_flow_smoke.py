...
SCENARIOS = [
    ...
    {
        "slug": "feature-flag-control-plane",
        "goal": "Build a production-ready feature flag control plane with rollout rules, targeting, audit logs, and safe configuration updates.",
        "learning_outcomes": [
            "Evaluate flags consistently for each environment and actor.",
            "Support safe updates with audit trails and rollback-friendly workflows.",
