            ...
            input=[
                {
                    ...
                    "content": (
                        ...
                        "When `failure_context.previously_verified_runtime` is present, that runtime bundle already passed sandbox verification. "
                        "Preserve those runtime protocol files and dependency-contract facts unless the current failure packet explicitly proves they caused the new failure. "
                        "Do not rewrite known-good runtime wiring to fix reviewer-only findings. "
